...
<g:if test="${ providers && providers.size() > 0 }">
<ul>
	<g:each in="${ providers.sort{a,b-> a.name.toLowerCase().compareTo(b.name.toLowerCase())} }"
		...
		<li><h1>
			...
			<g:if test="${ provider.series && provider.series.size() > 0 }">
			<ul>
				<g:each
					...
					<li><h2>
						...
						<g:if test="${ serie.seasons && serie.seasons.size() > 0 }">
						<ul>
							<g:each
								...
								<li><h3>
									...
									<g:if test="${ season.episodes && season.episodes.size() > 0 }">
									<ul>
										<g:each
											...
											<li><h4>
												...
												<g:if test="${ episode.downloadInfo && episode.downloadInfo.size() > 0 }">
												<ul>
